    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-6 mb-3">1. Free Plan</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-6 mb-3">3. Business Plan (Rs. 499/month)</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-6 mb-3">5. Cancellation</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-6 mb-3">6. Refund processing time</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-6 mb-3">8. Failed payments</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-6 mb-3">10. Changes to this policy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mt-6 mb-3">11. Contact</h2>
